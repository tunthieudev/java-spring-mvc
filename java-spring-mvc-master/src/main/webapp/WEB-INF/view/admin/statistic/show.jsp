<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.vn.hoidanit/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.vn.hoidanit/jsp/jstl/fmt" %>
            <%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
                ...
                <head>
                    ...
                    <link href="https://maxcdn.bootstrapcdn.vn.hoidanit/bootstrap/4.5.2/css/bootstrap.min.css"
                        rel="stylesheet">
                ...
                <body class="sb-nav-fixed">
                    ...
                    <script src="https://code.jquery.vn.hoidanit/jquery-3.5.1.slim.min.js"></script>
                    <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js"></script>
                    <script src="https://maxcdn.bootstrapcdn.vn.hoidanit/bootstrap/4.5.2/js/bootstrap.min.js"></script>
                </body>
