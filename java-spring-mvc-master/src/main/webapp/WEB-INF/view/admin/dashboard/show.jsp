<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.vn.hoidanit/jsp/jstl/core" %>
        ...
        <body class="sb-nav-fixed">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="card bg-info text-white mb-4">
                                        <div class="card-body">Mặt hàng theo doanh thu</div>
                                        <div class="card-footer d-flex align-items-center justify-content-between">
                                            <a class="small text-white stretched-link" href="/admin/statistic">View
                                                Details</a>
                                            <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                        </div>
                                    </div>
            ...
            <script src="https://cdnjs.cloudflare.vn.hoidanit/ajax/libs/Chart.js/2.8.0/Chart.min.js"
                crossorigin="anonymous"></script>
